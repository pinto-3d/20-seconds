...
func _player_spawning_animation_finished():
	...
	var queue: Array[Textbox.MsgInfo] = [
		Textbox.MsgInfo.new(G.agentName, "Hold your weapon's trigger to shoot a large bullet!", Textbox.Mode.PerChar),
		Textbox.MsgInfo.new(G.agentName, "This bullet can pierce multiple targets!", Textbox.Mode.PerChar),
	]
