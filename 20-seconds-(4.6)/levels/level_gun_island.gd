...
func _player_spawning_animation_finished():
	...
	var queue: Array[Textbox.MsgInfo] = [
		Textbox.MsgInfo.new(G.agentName, "Decided to get a bit creative! Find the treasure on the pirate island haha.", Textbox.Mode.PerChar),
		Textbox.MsgInfo.new(G.agentName, "haha... Anyways, good luck.", Textbox.Mode.PerChar),
	]
